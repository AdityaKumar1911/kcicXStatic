...
export default function AerospaceHeroSection() {
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img 
          src="https://d64gsuwffb70l.cloudfront.net/68ee314aa177c7fe5f473f1b_1763055010340_8cc67e40.webp" 
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-12">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
            BEng (Hons) Aerospace Engineering with Placement
          </h1>
          
          <p className="text-xl sm:text-2xl text-[#FAF3E0] mb-8">
            Design the future of flight with cutting-edge aerospace technology
          </p>

          <div className="flex flex-wrap gap-4 mb-8 text-white">
            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg">
              <Clock className="w-5 h-5 text-[#B99750]" />
              <span className="font-semibold">4 years | 2 years in India & 2 years in the UK</span>
            </div>
            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg">
