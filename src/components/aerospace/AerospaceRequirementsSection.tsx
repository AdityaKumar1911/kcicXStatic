...
export default function AerospaceRequirementsSection() {
  return (
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-700 text-base leading-relaxed">12th Grade with 60% in Mathematics and Physics</p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-6 h-6 text-[#B99750] flex-shrink-0 mt-1" />
              ...
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-6 h-6 text-[#B99750] flex-shrink-0 mt-1" />
                <p className="text-gray-700 text-base leading-relaxed">Interest in aviation and aerospace technology</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-xl border-2 border-[#B99750]/30">
                ...
                <p className="text-gray-600 text-base">Build foundations in aerodynamics, materials, and aircraft systems</p>
              </div>
              <div className="bg-white p-6 rounded-xl border-2 border-[#B99750]/30">
                <h3 className="text-xl font-bold text-[#0B1B3A] mb-2">Years 3-4: UK University</h3>
                <p className="text-gray-600 text-base">Advanced aerospace modules with industry placement at leading companies</p>
              </div>
            </div>
          </div>
        </div>
