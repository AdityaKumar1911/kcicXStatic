...
const reasons = [
  { icon: Award, title: 'Industry Partnerships', desc: 'Collaborate with leading aerospace companies like Airbus, Rolls-Royce, and BAE Systems' },
  { icon: Users, title: 'Expert Faculty', desc: 'Learn from aerospace engineers and industry professionals' },
  { icon: Briefcase, title: 'Hands-on Projects', desc: 'Work on real aircraft systems and design projects' },
...
export default function AerospaceWhyKCICSection() {
  return (
    <section className="py-16 sm:py-20 bg-white">
      <Layout>
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#0B1B3A] mb-12 text-center">Why Study Aerospace at KCIC?</h2>
