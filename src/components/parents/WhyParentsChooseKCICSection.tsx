...
const WhyParentsChooseKCICSection = () => {
            ...
            return (
              ...
              >
                ...
                <CardContent className="p-6">
                  <div className="inline-flex p-3 rounded-xl bg-gradient-to-br from-[#B99750] to-[#d4af37] mb-4">
...
export default WhyParentsChooseKCICSection;
