...
export default function AccountingHeroSection() {
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img 
          src="https://d64gsuwffb70l.cloudfront.net/68ee314aa177c7fe5f473f1b_1763086729495_826589be.webp"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-12">
        <div className="max-w-3xl">
          ...
          <p className="text-xl sm:text-2xl text-[#FAF3E0] mb-8">
            Fast-track your ACCA qualification with up to 9 exemptions
          </p>
