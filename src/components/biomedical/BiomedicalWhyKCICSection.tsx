...
const reasons = [
  { icon: Award, title: 'HCPC Accredited', desc: 'Study a program recognized by Health and Care Professions Council' },
  { icon: Users, title: 'Expert Faculty', desc: 'Learn from experienced biomedical scientists and researchers' },
  { icon: Briefcase, title: 'Clinical Placement', desc: 'Gain practical experience in NHS and private laboratories' },
...
export default function BiomedicalWhyKCICSection() {
  return (
    <section className="py-16 sm:py-20 bg-white">
      <Layout>
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#0B1B3A] mb-12 text-center">Why Study Biomedical Science at KCIC?</h2>
