...
export default function AIRequirementsSection() {
  return (
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-gray-700 text-base leading-relaxed">12th Grade with 60% in Mathematics and any two science subjects</p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-6 h-6 text-[#B99750] flex-shrink-0 mt-1" />
              ...
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-6 h-6 text-[#B99750] flex-shrink-0 mt-1" />
                <p className="text-gray-700 text-base leading-relaxed">Strong analytical and problem-solving skills</p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="w-6 h-6 text-[#B99750] flex-shrink-0 mt-1" />
                <p className="text-gray-700 text-base leading-relaxed">Interest in programming and technology</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-xl border-2 border-[#B99750]/30">
                ...
                <p className="text-gray-600 text-base">Build foundations in AI, programming, and data science with hands-on projects</p>
              </div>
              <div className="bg-white p-6 rounded-xl border-2 border-[#B99750]/30">
                <h3 className="text-xl font-bold text-[#0B1B3A] mb-2">Years 3-4: UK University</h3>
                <p className="text-gray-600 text-base">Advanced AI modules with industry placement at leading tech companies</p>
              </div>
            </div>
          </div>
        </div>
