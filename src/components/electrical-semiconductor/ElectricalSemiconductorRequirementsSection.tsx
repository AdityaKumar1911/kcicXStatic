...
export default function ElectricalSemiconductorRequirementsSection() {
  const requirements = [
    "A-Levels: BBB including Mathematics and Physics",
    "BTEC: DDM in Engineering or related subject",
    "International Baccalaureate: 30 points including HL Maths and Physics",
    "Access to HE Diploma: Pass with 45 credits at Level 3",
    "Strong interest in electronics and semiconductor technology",
    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
        ...
        <p className="text-xl text-center text-gray-600 mb-12 max-w-3xl mx-auto">
          We welcome applications from students with diverse backgrounds and qualifications
        </p>
