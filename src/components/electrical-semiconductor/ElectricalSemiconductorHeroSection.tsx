...
export default function ElectricalSemiconductorHeroSection() {
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img 
          src="https://d64gsuwffb70l.cloudfront.net/68ee314aa177c7fe5f473f1b_1763089902025_22b8d418.webp" 
          alt="Electrical & Semiconductor Engineering" 
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-12">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
            BEng (Hons) Electrical & Electronics + Semiconductor Technology
          </h1>
          
          <p className="text-xl sm:text-2xl text-[#FAF3E0] mb-8">
            Master cutting-edge semiconductor design and electronics engineering for the global chip industry
          </p>
